...
<br/>
In the past few months, I've been working on expanding the number of programming languages and frameworks/tools I'm familiar with - currently looking at Javascript (Node). I also have interest in expanding my knowledge to the front-end techs, such as React and Angular. But one thing at a time :)<br/>
